...
// Add reference to SystemManagement (from Add > Reference > Assembly > SystemManagement)
...
namespace CentralControlSoftware
{
    ...
    public class VlcRemote
    {
        ...
        public VlcRemote()
        {
            ...
            if (vlcPath == null)
            {
                // Manually setting vlc path
                //vlcPath = @"C:\Program Files (x86)\VLC\vlc.exe";

                string tempPath = @"C:\Program Files (x86)\VLC";
                ...
                {
                    vlcPath = @"C:\Programmi (x86)\VideoLAN\VLC\vlc.exe";
                }
            }
            ...
            try 
            {
                ...
                ////var info = new ProcessStartInfo(vlcPath, "-I rc --rc-host=localhost:9876 --qt-fullscreen-screennumber=1");
                //vlcProcess = Process.Start(info);

                vlcProcess = new Process();
                vlcProcess.StartInfo.WindowStyle = ProcessWindowStyle.Minimized;
                vlcProcess.StartInfo.FileName = vlcPath;
                vlcProcess.StartInfo.Arguments = "-I rc --rc-host=localhost:9876";
                vlcProcess.Start();
            ...
            {
                throw new ApplicationException("Cannot find the VLC executable!");
            }
        }
        ...
        public void Repeat()
        {
            SendCommand(VlcCommand.Repeat, "off");
        }
